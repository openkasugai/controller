---
weight: 3
title: "pipeline_spec.proto改修"
---
# pipeline_spec.proto改修
## この手順について
* Custom Kubeflow SDKを実行するにあたり、Kubeflow Pipelines SDKの修正箇所について記載する。

## 対応内容
* `pipeline_spec.proto`を編集し、Kfp Clientが利用するpipeline_specの構造体をOpenKasugai向けに変更する。(※1)
...
## 手順
1. `pipeline_spec.proto`をテキストエディタで開く。
```
