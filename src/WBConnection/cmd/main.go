...
import (
	...
	"WBConnection/internal/controller"
...
func main() {
	...
	/* metric server port */
	ms_port := os.Getenv("K8S_WBC_MS_PORT")
	if ms_port != "" {
		metricsAddr = ":" + ms_port
	}
	...
	hc_port := os.Getenv("K8S_WBC_HC_PORT")
	if hc_port != "" {
		probeAddr = ":" + hc_port
	}
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "14b2538c.example.com",
	...
	if err = (&controller.WBConnectionReconciler{
		Client:   mgr.GetClient(),
		Scheme:   mgr.GetScheme(),
		Recorder: mgr.GetEventRecorderFor("wbconnection-ctrl"),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "WBConnection")
		os.Exit(1)
	}
	//+kubebuilder:scaffold:builder
	controller.LoadConfigMap(&controller.WBConnectionReconciler{
		Client:   mgr.GetClient(),
		Scheme:   mgr.GetScheme(),
		Recorder: mgr.GetEventRecorderFor("wbconnection-ctrl"),
	})
