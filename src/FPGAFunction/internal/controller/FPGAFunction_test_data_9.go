...
var childbsid9 string = "00000002"
var maxFunctions9 int32 = 1
var maxCapacity9 int32 = 2
var name9_1 string = "lane0"

// var name9_2 string = "lane1"

var cids9 string = "111"
var id9 int32 = 3
var identifier9 string = "child1_identifier"
var typ9 string = "childbs_chaintype"
var varsion9 string = "childbs_varsion1.1.3"
var maxDataflows9 int32 = 4
var available9 bool = true
var funcCRName9 string = "funcCRName"
var port9_1 int32 = 5
var dmaChannel9_1 int32 = 6
var lldmaConnector9_1 int32 = 7
var port9_2 int32 = 8
var dmaChannel9_2 int32 = 9
var lldmaConnector9_2 int32 = 10
var uid9 types.UID = "uid9"
var functionchannelids9 string = "0-7"

var ChildBitstream9 = examplecomv1.ChildBs{
	TypeMeta: metav1.TypeMeta{
		APIVersion: "example.com/v1",
		Kind:       "Childbs",
	},
					...
					Functions: &[]examplecomv1.ChildBsFunctions{
						{
							...
							Module: &[]examplecomv1.FunctionsModule{{
								FunctionChannelIDs: &functionchannelids9,
								Identifier:         &identifier9,
								Type:               &typ9,
								Version:            &varsion9,
							}},
							...
							IntraResourceMgmtMap: &map[string]examplecomv1.FunctionsIntraResourceMgmtMap{
								"1": {
									Available:      &available9,
									FunctionCRName: &funcCRName9,
									Rx: &examplecomv1.RxTxSpec{

										Protocol: &map[string]examplecomv1.ChildBsDetails{
											"RTP": {
												Port:             &port9_1,
												DMAChannelID:     &dmaChannel9_1,
												LLDMAConnectorID: &lldmaConnector9_1,
											},
										},
									},
									Tx: &examplecomv1.RxTxSpec{
										Protocol: &map[string]examplecomv1.ChildBsDetails{
											"DMA": {
												Port:             &port9_2,
												DMAChannelID:     &dmaChannel9_2,
												LLDMAConnectorID: &lldmaConnector9_2,
											},
										},
									},
								},
							...
							DeploySpec: examplecomv1.FunctionsDeploySpec{
								...
								MaxDataFlows: &maxDataflows9,
							},
						},
					},
				},
				MaxFunctions: &maxFunctions9,
				MaxCapacity:  &maxCapacity9,
				Name:         &name9_1,
			},
		},
		ChildBitstreamID: &childbsid9,
	},
...
var deployinfo_configdata9 = corev1.ConfigMap{
	ObjectMeta: metav1.ObjectMeta{
		Name:      "deployinfo",
		Namespace: "default",
	},
...
var resetflg9 bool = true
var FPGAReconfiguration9 = examplecomv1.FPGAReconfiguration{
	TypeMeta: metav1.TypeMeta{
		APIVersion: "example.com/v1",
