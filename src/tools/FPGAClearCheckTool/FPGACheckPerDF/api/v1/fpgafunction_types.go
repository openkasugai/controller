...
type FPGAFunctionStatus struct {
	...
	Rx                  RxTxData                          `json:"rx"`
	Tx                  RxTxData                          `json:"tx"`
	AcceleratorStatuses []FPGAFunctionAccStatusesByDevice `json:"acceleratorStatuses,omitempty"`
}

type FPGAFunctionAccStatusesByDevice struct {
	PartitionName *string                   `json:"partitionName,omitempty"`
	Statused      []FPGAFunctionAccStatuses `json:"statuses,omitempty"`
}

type FPGAFunctionAccStatuses struct {
