...
type CPUFunctionStatus struct {
	...
	AcceleratorStatuses []CPUFunctionAccStatusesByContainer `json:"acceleratorStatuses,omitempty"`
}

type CPUFunctionAccStatusesByContainer struct {
	PartitionName *string                  `json:"partitionName,omitempty"`
	Statuses      []CPUFunctionAccStatuses `json:"statuses,omitempty"`
}

type CPUFunctionAccStatuses struct {
